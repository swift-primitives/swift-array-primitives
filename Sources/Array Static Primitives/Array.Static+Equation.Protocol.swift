...
extension Array.Static: Equation.`Protocol` where Element: Equation.`Protocol` & ~Copyable {
    /// Compares two static arrays for element-wise, ordered-sequence equality, over

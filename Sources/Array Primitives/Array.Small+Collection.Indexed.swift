...
extension Array.Small: Collection.Indexed {
    ...
    // subscript(position:) already defined in Array.Small.swift with _read accessor
...
extension Array.Small: Collection.Indexed_Bidirectional {
    @inlinable

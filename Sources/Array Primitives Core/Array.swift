...
// Note: Array.Bounded, Array.Inline, and Array.Small are UNCONDITIONALLY ~Copyable
// due to their deinit requirements for storage cleanup.
...
// MARK: - ElementStorage Copyable Extension
